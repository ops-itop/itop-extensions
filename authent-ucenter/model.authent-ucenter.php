...
class UserUCenter extends UserInternal
{
	...
	{
		$sAppRootURL = MetaModel::GetConfig()->Get('app_root_url');
		$sUrlSSO = MetaModel::GetModuleSetting('authent-lesso', 'url', 'http://localhost');
		
		header("Location: ". $sUrlSSO . "?backurl=" . $sAppRootURL . "&site=" . $sSite);
